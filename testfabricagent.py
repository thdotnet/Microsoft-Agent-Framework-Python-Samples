...
of the Fabric environment using DefaultAzureCredential authentication.
...
2. Run the script - it will use DefaultAzureCredential for authentication
...
class FabricDataAgentClientNew:
    """
    Client for calling Microsoft Fabric Data Agents from external applications.
    
    This client handles:
    - DefaultAzureCredential authentication with Azure AD
    ...
    def _authenticate(self):
        """
        Perform DefaultAzureCredential authentication and get initial token.
        """
        try:
            print("\n🔐 Starting authentication...")
            print("Using DefaultAzureCredential to authenticate.")
            
            # Create credential using DefaultAzureCredential chain
